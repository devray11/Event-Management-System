...
<div class="heading" style="background:url(images/book_events.png) no-repeat">
   <h1>ㅤㅤ</h1>
</div>

<section class="booking">

   <h1 class="heading-title">Book Events</h1>
...
<div>
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="Enter your email address" name="address">
         </div>
         <div class="inputBox">
            <span>College Name</span>
            <input type="text" placeholder="Enter your college name" name="location">
         </div>
      </div>
      <input type="submit" value="submit" class="btn" name="send">
      <a href="https://forms.gle/h6UexAmJfQJBX6CH6">
         <input type="button" value="Pay Now" class="btn">
      </a>
